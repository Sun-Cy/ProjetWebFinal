...
<div><label for="">Max SPL (Sound Pressure Level en dB): </label><?php $maxSPL = $micro->get_maxSPL(); if(isset($maxSPL)){ echo $micro->get_maxSPL();} else{ echo 'Pas spécifié';} ?><br></div>
<div><label for="">Rated Impedance : </label><?php $ratedImp =  $micro->get_ratedImpedance(); if(isset($ratedImp)){ echo $micro->get_ratedImpedance();} else{ echo 'Pas spécifié';} ?><br></div>
